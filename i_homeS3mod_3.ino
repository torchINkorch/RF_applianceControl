...
void loop() {
  ...
  if(Serial2.available()>0){
    uint8_t recievedData = Serial2.parseInt();
    if(recievedData != 0){
      switch(recievedData){
        case 116: rf1.updatememApplianceState(); break;
        case 126: rf2.updatememApplianceState(); break;
        case 136: rf3.updatememApplianceState(); break;
        case 146: rf4.updatememApplianceState(); break;
        case 156: rf5.updatememApplianceState(); break;
        case 166: rf6.updatememApplianceState(); break;
      }
    }
  }
      ...
      switch (pageID) {
        ...
        case 12:  //------------> page settings ->rf modules
          switch (cmpID) { //------> wireless rf module enable/disable
            ...
            case 7:  rf7.changeSelfState(); reset(); break;     //------> wireless rf7 en/di
            case 8:  rf8.changeSelfState(); reset(); break;     //------> wireless rf8 en/di
